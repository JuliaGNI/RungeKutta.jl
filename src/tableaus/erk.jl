...
function TableauExplicitEuler()
    ...
    Tableau(:explicit_euler, o, a, b, c)
end
...
function TableauExplicitMidpoint()
    ...
    Tableau(:explicit_midpoint, o, a, b, c)
end
