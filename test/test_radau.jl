...
@testset "$(rpad("Radau Tableaus",80))" begin
    ...
    function _TableauRadauIIA3(T = Float64)
        a = [[11/45 - 7*√6/360 37/225-169*√6/1800 -2/225+√6/75]
    ...
    function _TableauRadauIIB3(T = Float64)
        a = [[(16 - √6)/72 (328 - 167*√6)/1800 (-2 + 3*√6)/450]
    ...
    @test radau_legendre_nodes(Float32, 2, Val(:left)) ≈
          radau_legendre_nodes(Float64, 2, Val(:left))
    @test radau_legendre_weights(Float32, 2, Val(:left)) ≈
          radau_legendre_weights(Float64, 2, Val(:left))
    @test radau_1_coefficients(Float32, 2) ≈ radau_1_coefficients(Float64, 2)

    @test radau_legendre_nodes(Float32, 2, Val(:right)) ≈
          radau_legendre_nodes(Float64, 2, Val(:right))
    @test radau_legendre_weights(Float32, 2, Val(:right)) ≈
          radau_legendre_weights(Float64, 2, Val(:right))
    @test radau_2_coefficients(Float32, 2) ≈ radau_2_coefficients(Float64, 2)

    @test radau_legendre_nodes(symtype(), 2, Val(:left)) ≈
          radau_legendre_nodes(Float64, 2, Val(:left))
    @test radau_legendre_weights(symtype(), 2, Val(:left)) ≈
          radau_legendre_weights(Float64, 2, Val(:left))
    @test radau_1_coefficients(symtype(), 2) ≈ radau_1_coefficients(Float64, 2)

    @test radau_legendre_nodes(symtype(), 2, Val(:right)) ≈
          radau_legendre_nodes(Float64, 2, Val(:right))
    @test radau_legendre_weights(symtype(), 2, Val(:right)) ≈
          radau_legendre_weights(Float64, 2, Val(:right))
